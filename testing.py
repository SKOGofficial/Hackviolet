...
arguments = "&ingredients=apples,+flour,+sugar" #a little bit more complicated because arguments depends on the mode, Save for later
number_of_recipies = "&number=2"
